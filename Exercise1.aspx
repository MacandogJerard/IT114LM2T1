...
<body>
    ...
    <form runat="server">
        ...
        <div>
             <asp:Label ID="Label1" runat="server" Text="Better Days - Franco"></asp:Label>
        </div>
        ...
        <div>
            <asp:Image ID="Image1" runat="server" Width="200px" ImageUrl="~/th.jpg" AlternateText="AlbumCover" />
        </div>
